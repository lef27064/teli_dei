...
Στην έκδοση (4.7)
1.	Επιλύθηκαν (μικρότερα) προβλήματα προηγούμενων εκδόσεων, 
2.	Επιλύθηκε το πρόβλημα της ταξινόμησης του αρχικού πίνακα
3.	Προστέθηκε μαζική εύρεση - επεξεργασία για συγκεκριμένες τιμές ζώνης.

Στην έκδοση (4.6) έχει 
